...
function getPDFFileNameFromURL(url) {
    var defaultFilename = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : TITLE + ".pdf";
...
var defaultOptions = {
  ...
  defaultUrl: {
    value: '',
    //value: 'compressed.tracemonkey-pldi-093333333.pdf',
    kind: OptionKind.VIEWER
  },
  defaultZoomValue: {
    value: '',
  ...
  workerSrc: {
    value: '/dist/js/jspdf/build/pdf.worker.js',
    kind: OptionKind.WORKER
  }
};
{
