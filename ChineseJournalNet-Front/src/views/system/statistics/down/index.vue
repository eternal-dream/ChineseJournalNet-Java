  ...
  <d2-container type="full">
    <template slot="header">
      ...
      <el-form :model="queryParams" ref="form" size="small" :inline="true">
        ...
        <el-col :span=6>
            <el-form-item label="刊名" prop="journalName" label-width="80px">
                <el-input v-model="queryParams.journalName" />
            </el-form-item>
        </el-col>
        <el-col :span=6>
            <el-form-item label="分类" prop="classify" label-width="80px">
              <el-select v-model="queryParams.classNumber" size="mini" :filterable="true" :collapse-tags="true" multiple :clearable="true" placeholder="请选择分类">
        ...
        <el-col :span=6>
            <el-form-item label="用户组" prop="userGroupId" label-width="80px">
                <el-select v-model="queryParams.userGroupId" size="mini" :collapse-tags="true" :clearable="true" placeholder="请选择用户组">
        ...
        <el-col :span=24>
            <el-form-item label="分析对象" prop="type" label-width="80px">
                <el-radio-group v-model="queryParams.type">
                    <el-radio label="classify">分类</el-radio>
      ...
      <el-table :data="analysisResult" size="mini" empty-text="未查询到信息" stripe>
        ...
        <el-table-column prop="COUNT" label="所占比例" min-width='100px' align="center" >
          <template slot-scope="scope">
            <el-progress v-show="analysisResult.length>1" :percentage="analysisResult[analysisResult.length-1].COUNT == 0 ? 100:parseInt(scope.row.COUNT/analysisResult[analysisResult.length-1].COUNT * 100)"></el-progress>
          </template>
        </el-table-column>
      </el-table>
    </template>
...
export default {
  ...
  methods: {
    analysis () {
      ...
      axios({
        method: 'post',
        url: '/system/statistics/downloadAnalysis',
    ...
    handleExport () {
      ...
      axios({
        method: 'post',
        url: '/system/statistics/downloadExport',
        data: this.queryParams,
        responseType: 'blob'
      })
